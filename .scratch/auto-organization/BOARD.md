...
- 已发布：3（01、02、03）。已认领：0。已完成：0。已合并：0。
...
|---|---|---|---|
| [01 标签语义聚类与批量治理](issues/01-tag-vocabulary-clustering.md) | 整理 | 无 | ready-for-agent |
| [02 相似笔记自动归类到集合（文件夹）](issues/02-auto-collection-assignment.md) | 整理 | 无 | ready-for-agent |
| [03 显著连续笔记的检测与合并](issues/03-continuity-merge.md) | 整理 | 无 | ready-for-agent |
