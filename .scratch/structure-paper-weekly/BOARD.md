...
| Y5 | ❌ R3 REJECT（rev-128，verdict `/tmp/review-spw-Y5-r3-verdict.md`）→ 作者-111 R4 返工中 | `dev/Y5-author-split` @ `2ca3e70` | D3：折行标题次行以 Abstract/摘要 开头被当行首标签，真实摘要被顶替（R1 起三版全错、入口从未堵）；修复方向已原型验证零回归（title_lines 传入排除标题块行） |
