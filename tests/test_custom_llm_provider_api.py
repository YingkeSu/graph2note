...
def test_settings_ui_exposes_custom_provider_controls(tmp_path):
    ...
    # U1 moved the LLM settings view into an ES module; A3's custom-provider
    # section lives there now (index.html keeps the element ids).
    javascript = client.get("/static/js/views/settings.js").text
