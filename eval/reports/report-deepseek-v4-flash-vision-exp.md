...
- 样本均值 EditRate: **1.2017** (120.17%)
- 聚合 EditRate（Σ编辑字符 / Σgold 字符）: 1.2350 | Σ编辑字符 678 / Σgold 字符 549
- 目标: < 5.0% (SC-001)
...
| formula | 数学公式 | 0 | — | — | — | 0 |
| mixed | 中英混排 | 0 | — | — | — | 0 |
| flowchart | 流程图/架构图 | 2 | 1.2017 | 0.9295 | 1.4740 | 2 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 01-requirements-arch | 流程图/架构图 | 1.4740 | 454 | 233 | 0 | 221 | 308 | 541 | 否 | ok | 64.4600 | 5532 | 0 | 否 |
| 02-digitize-pipeline | 流程图/架构图 | 0.9295 | 224 | 27 | 8 | 189 | 241 | 260 | 否 | ok | 54.0700 | 6170 | 0 | 否 |
